...
class DetailViewController: UIViewController {
    ...
    private func updateUI() {
        ...
        completeImage.image = completedImage?.withRenderingMode(.alwaysTemplate)
...
extension DetailViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        guard let annotationView = map.dequeueReusableAnnotationView(withIdentifier: TaskAnnotationView.identifier, for: annotation) as? TaskAnnotationView else {
